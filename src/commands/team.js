...
const data = new SlashCommandBuilder()
  ...
  .addSubcommand(sub => sub.setName('erstellen').setDescription('Legt ein neues Team an.')
    .addStringOption(o => o.setName('name').setDescription('Teamname').setRequired(true))
    .addStringOption(o => o.setName('kuerzel').setDescription('Kurzes Kürzel, z. B. MAIN oder ACA').setRequired(false))
    .addRoleOption(o => o.setName('rolle').setDescription('Discord-Rolle des Teams').setRequired(false))
    .addChannelOption(o => o.setName('admin_kanal').setDescription('Privater Adminkanal').addChannelTypes(ChannelType.GuildText).setRequired(true))
    .addChannelOption(o => o.setName('verfuegbarkeit_kanal').setDescription('Kanal für Wochenkarten').addChannelTypes(ChannelType.GuildText).setRequired(true))
    .addChannelOption(o => o.setName('spielerkalender_kanal').setDescription('Kanal für gespiegelte Termine').addChannelTypes(ChannelType.GuildText).setRequired(true))
    .addChannelOption(o => o.setName('scrim_kanal').setDescription('Optionaler Scrim-Kanal').addChannelTypes(ChannelType.GuildText).setRequired(false))
    .addChannelOption(o => o.setName('primeleague_kanal').setDescription('Optionaler Prime-League-Kanal').addChannelTypes(ChannelType.GuildText).setRequired(false)))
  .addSubcommand(sub => {
